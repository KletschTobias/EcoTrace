...
-- New CSV activities inserted below 
...
(nextval('activities_seq'), 'Uber Car Trip', 'transport', 0.210, 0.0, 0.0, 'km', '🚖', 'Using an Uber to drive you from A to B'),
(nextval('activities_seq'), 'E-Bike Ride', 'transport', 0.015, 0.0, 0.02, 'km', '🚲', 'Riding an electric bicycle'),
(nextval('activities_seq'), 'E-Scooter Ride', 'transport', 0.020, 0.0, 0.03, 'km', '🛴', 'Riding an electric scooter'),
...
(nextval('activities_seq'), 'Hair Dryer Use', 'home', 0.05, 0.0, 0.15, 'times', '💨', 'Drying hair with an electric hair dryer'),
(nextval('activities_seq'), 'Ironing Clothes', 'home', 0.12, 0.0, 0.25, 'hours', '🧺', 'Ironing clothes with an electric iron'),
(nextval('activities_seq'), 'Air Fryer Use', 'home', 0.25, 0.0, 0.5, 'times', '🍟', 'Cooking food in an air fryer'),
(nextval('activities_seq'), 'Kettle Boil', 'home', 0.03, 0.0, 0.07, 'times', '☕', 'Boiling water in an electric kettle'),
(nextval('activities_seq'), 'Dehumidifier Use', 'home', 0.06, 0.0, 0.15, 'hours', '💦', 'Running a room dehumidifier'),
(nextval('activities_seq'), 'Streaming Video', 'home', 0.10, 0.0, 0.20, 'hours', '📹', 'Streaming video online'),
(nextval('activities_seq'), 'Music Speaker', 'home', 0.02, 0.0, 0.05, 'hours', '🔊', 'Listening to music on speakers'),
